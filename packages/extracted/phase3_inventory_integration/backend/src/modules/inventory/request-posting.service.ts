...
async function nextId(db: Db, table: string, idCol: string, sc: number, loc: number) {
...
async function getOnHand(db: Db, store_id: number, item_id: string, sc: number, loc: number) {
