...
export default function InventoryRequests() {
  ...
  return (
    <div>
      ...
      <Callout title="Phase 3.16 (Unpost Reversal + Posting Guards)">
        قبل الـ Post فيه Check + Unpost دلوقتي بيرجع الحركة ويمسح posted docs (Header Approved + No Pending Lines + Not Posted). UI بتعرض Can Post + Reason.
      </Callout>
